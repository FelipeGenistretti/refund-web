...
export function Confirm(){
    ...
    return(
        <div className="bg-gray-500 lg:w-[512px] rounded-lg flex flex-col items-center p-10 gap-6 ">
            ...
            <p className="text-sm text-gray-200 text-center">Agora é apenas aguardar! Sua solicitação será
                analisada e, em breve, o 
                setor financeiro irá encontrar contato com você
